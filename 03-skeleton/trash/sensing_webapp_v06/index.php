...
?><!doctype html>
<meta charset="utf-8">
<title>Gmail IMAP → LLM 센싱 자동화 (v06)</title>
<style>
...
#popup header{background:#1f2937;color:#fff;border-radius:12px 12px 0 0;padding:8px 12px;cursor:default}
...
<header>
  <div>
    <strong>Gmail IMAP → OpenRouter LLM 센싱 자동화 (v06)</strong>
