...
function analyze_and_save(string $emailBody, int $max_tokens, float $temperature, array $api, string $uid='', string $subject=''): array {
    ensure_dirs();
    $messages = [
    ...
    $raw = null;
    $ret = llm_chat_complete($messages, $max_tokens, $temperature, $api, $raw);
    $ok = $ret[0]; 
