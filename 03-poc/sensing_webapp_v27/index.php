...
<div style="margin-left:auto;display:flex;gap:8px;align-items:center">
      ...
      <table style="width:100%;table-layout:fixed;">
        <thead><tr><th style="width:70px">삭제</th><th class="small" style="width:60px">#</th><th style="width:50%">제목</th><th style="width:20%">보낸사람</th><th style="width:15%">날짜</th><th style="width:280px">동작</th></tr></thead>
        <tbody>
  ...
  <form method="post" action="?action=delete" style="display:inline" onsubmit="return __confirmDelete(event);">
    ...
    <button class="btn" type="submit">삭제</button>
            ...
            <td style="width:50%;word-break:break-word;overflow:hidden;text-overflow:ellipsis;">
              <?php if ($__proto !== 'POP3' && !empty($m['is_new'])): ?><span class="badge badge-new">New</span><?php endif; ?>
              <?=h($m['subject'])?>
            </td>
            <td style="width:20%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?=h($m['from'])?></td>
