...
function open_mailbox(array $cfg) {
    ...
    $imap = @imap_open($mboxStr, $username, $password, 0, 1, [
        'DISABLE_AUTHENTICATOR' => 'GSSAPI', // 일부 환경에서 지연 방지
    ]);
    if (!$imap) {
...
/** 본문: text/plain 우선, 없으면 text/html -> strip_tags */
